...
let ChatHistoryComponent = class ChatHistoryComponent {
    constructor(pService, chatService) {
        this.pService = pService;
        this.chatService = chatService;
        this.username = "";
        this.x = setInterval(() => {
            this.chatService.getHistory().subscribe((response) => {
    ...
    saveMsg(value) {
        ...
        if (this.pService.statusNickname == true) {
            ...
            this.chatService.addToHistory(new _message__WEBPACK_IMPORTED_MODULE_4__["Message"](this.pService.nickname, this.alert, new Date(), this.pService.colorName)).subscribe((response) => {
                console.log('REST server gave back ' + response);
            });
            this.pService.statusNickname = false;
        }
        this.chatService.addToHistory(new _message__WEBPACK_IMPORTED_MODULE_4__["Message"](this.pService.nickname, value, new Date(), this.pService.colorName)).subscribe((response) => {
            console.log('REST server gave back ' + response);
        });
    }
};
ChatHistoryComponent.ctorParameters = () => [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("form, p, span {\r\n    margin:0;\r\n    padding:0; }\r\n  \r\n#username { font:12px arial; \r\n    width: 50%;\r\n    height: 30px;\r\n    padding: 0px;\r\n}\r\n  \r\n#usermsg {\r\n    width: 100%;\r\n    margin-left: 15px;\r\n    border:1px solid black;\r\n}\r\n  \r\n#submitmsg {\r\n    height: 40px;\r\n    width: 100%;\r\n    border: 1px solid black;\r\n}\r\n  \r\n.msgbefore{\r\n    margin-left: 15px;\r\n    height: 30px;\r\n}\r\n  \r\nlabel.msgbefore {\r\n    color: white;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
        ...
        if (this.username.match("^[a-zA-Z0-9äöü]{2,12}[._-|&|%|\S]{1,2}")) {
            ...
            if (this.username != this.pService.nickname) {
                if (this.pService.nickname != "") {
                    ...
                    this.chatService.addToHistory(new _message__WEBPACK_IMPORTED_MODULE_4__["Message"](this.username, this.alert, new Date(), this.pService.colorName)).subscribe((response) => {
                        console.log('REST server gave back ' + response);
                    });
                }
...
ChatbarComponent.ctorParameters = () => [
    { type: _person_service__WEBPACK_IMPORTED_MODULE_2__["PersonService"] },
    { type: _chat_service__WEBPACK_IMPORTED_MODULE_3__["ChatService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
class Message {
    constructor(username, content, timestamp, color) {
